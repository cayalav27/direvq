...
class Csegemp extends CI_Controller
{
	...
	public function index(){
		...
		switch($this->session->userdata('s_NomPrf')) {
		    ...
		    case 'Supervisor':
					...
					$this->load->view('Layout/Supervisor/menu_emp');
					$this->load->view('Supervisor/Seguimiento/vempleado');
    ...
    public function getPrf(){
        $setPrf = $this->input->post('indicador');
    ...
    public function getCrg(){
        $setCrg = $this->input->post('InsCodAre');
