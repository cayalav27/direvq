                            		...
                            		<div class="row">
                                        ...
                                        <div class="col-md-4">
                                             <div class="form-group row">
                                                <label class="col-md-12">Genero *</label>
                                                <div class="col-md-12">
                                                    <select class="form-control input-sm Sel2GnrEmp" id="EdtGnrEmp" name="EdtGnrEmp">
                                                        <option value="" selected=""></option>
                                        ...
                                        <div class="col-md-4">
                                             <div class="form-group row">
                                                <label class="col-md-12">Area *</label>
                                                <div class="col-md-12">
                                                    <select class="form-control input-sm select2" id="EdtCodAre" name="EdtCodAre">
	                                					<option value="" selected=""></option>
                                        ...
                                        <div class="col-md-4">
                                             <div class="form-group row">
                                                <label class="col-md-12">Cargo *</label>
                                                <div class="col-md-12">
                                                    <select class="form-control input-sm select2" id="EdtCodCrg" name="EdtCodCrg">
	                                					<option value="" selected=""></option>
														<option value="1">Sistemas</option>
	                                				</select>
                                                    <div class="help-block with-errors"></div>
                                        ...
                                        <div class="col-md-4">
                                             <div class="form-group row">
                                                <label class="col-md-12">Perfil *</label>
                                                <div class="col-md-12">
                                                    <select class="form-control input-sm Sel2CodPrf" id="EdtCodPrf" name="EdtCodPrf">
	                                					<option value="" selected=""></option>
                                        ...
                                        <div class="col-md-4">
                                             <div class="form-group row">
                                                <label class="col-md-12">Usuario *</label>
                                                <div class="col-md-12">
                                                    <input placeholder="No tiene información agregada" type="text" id="EdtUsrEmp" name="EdtUsrEmp" class="form-control input-sm">
                                                    <div class="help-block with-errors"></div>
                                                </div>
                                            </div>
                                        </div>
